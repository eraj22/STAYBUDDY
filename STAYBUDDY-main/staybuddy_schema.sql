...
--
-- TOC entry 221a (class 1259 OID 16420)
...
CREATE TABLE public.rooms (
    ...
    available_capacity integer NOT NULL,
    room_type character varying(20) DEFAULT 'shared'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT rooms_capacity_check CHECK ((capacity > 0)),
    CONSTRAINT rooms_available_check CHECK ((available_capacity >= 0))
);
...
--
-- TOC entry 221a (class 1259 OID 16551)
...
CREATE TABLE public.favorites (
    ...
    hostel_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT favorites_unique_user_hostel UNIQUE (user_id, hostel_id)
);

ALTER TABLE public.favorites OWNER TO postgres;

--
-- TOC entry 221b (class 1259 OID 16550)
...
COPY public.rooms (id, hostel_id, room_number, capacity, available_capacity, room_type, created_at) FROM stdin;
1	1	101	4	4	shared	2026-02-12 22:53:13.869839
2	1	102	4	3	shared	2026-02-12 22:53:13.869839
3	1	201	2	2	double	2026-02-12 22:53:13.869839
4	2	101	3	3	shared	2026-02-12 22:53:13.869839
5	2	102	3	3	shared	2026-02-12 22:53:13.869839
\.


--
-- TOC entry 4978b (class 0 OID 16447)
-- Dependencies: 226
-- Data for Name: bookings; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.bookings (id, user_id, hostel_id, room_id, check_in, check_out, status, created_at) FROM stdin;
1	1	1	\N	2026-03-01	2026-06-30	confirmed	2026-02-12 23:46:23.621695
\.
...
COPY public.hostels (id, name, address, city, university, latitude, longitude, total_capacity, available_capacity, description, created_at) FROM stdin;
1	Islamia Girls Hostel	Near Fast University, Islamabad	Islamabad	FAST-NUCES	33.73820000	72.99180000	180	40	Safe and secure girls hostel with mess and WiFi	2026-02-12 22:53:13.869839
2	Fatima Girls Hostel	G13/4 street 130 house number 26	Islamabad	IBA	33.73500000	72.99200000	120	25	Affordable hostel with laundry and study rooms	2026-02-12 22:53:13.869839
\.
...
--
-- TOC entry 4807 (class 2606 OID 16428)
...
--
-- TOC entry 4809 (class 2606 OID 16555)
...
ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_booking_room FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON DELETE SET NULL;


--
-- TOC entry 4820 (class 2606 OID 16430)
-- Name: rooms fk_room_hostel; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rooms
    ADD CONSTRAINT fk_room_hostel FOREIGN KEY (hostel_id) REFERENCES public.hostels(id) ON DELETE CASCADE;
...
-- Name: favorites fk_favorite_hostel; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.favorites
    ADD CONSTRAINT fk_favorite_hostel FOREIGN KEY (hostel_id) REFERENCES public.hostels(id) ON DELETE CASCADE;
